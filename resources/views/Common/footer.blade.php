                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-3 lg:col-span-3 md:col-span-6 sm:col-span-6 col:col-span-12 md:mb-[30px]">
                            <div class="px-[20px] lg:px-0 ">
                                ...
                                <ul>
                                    <li
                                        class="mb-[10px] text-white text-[15px] font-heading-font flex items-start gap-2">
                                        <div>
                                            <i class="ti-location-pin text-[#F78914]"></i>
                                        </div>
                                        <div>
                                    ...
                                    <li
                                        class="mb-[10px]  flex items-start gap-2 text-white text-[15px] font-heading-font">
                                        <div>
                                            <i class="ti-email text-[#F78914]"></i>
                                        </div>
                                        <div>
                                            <span>nutrey@gmail.com</span>
                                        </div>
                                    </li>
                                    <li
                                        class="mb-[10px] flex items-start gap-2 text-white text-[15px] font-heading-font">
                                        <div>
                                            <i class="ti-mobile text-[#F78914]"></i>
                                        </div>
                                        <div>
                                            <div>
                                                <a href="tel:">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <div class="col-span-12">
                            <p class="text-[15px] text-white text-center font-heading-font">
                                ...
                                <a href="index.html" class="text-[#F78914]">Gopalagriexport</a>
                            </p>
                        </div>
                    </div>
                </div>
