...
<body>
    ...
    <div class="page-wrapper">
        ...
        <header class="relative z-[111]">
                        ...
                        <div class="col-span-6">
                            <div class="flex justify-end md:justify-center gap-[15px] flex-wrap space-x-[10px]">
                                <div class="flex items-center justify-start gap-[10px]">
                                    ...
                                    <p class="text-[#232323] font-medium text-base leading-5 font-heading-font">0123
                                        456 789</p>
                                </div>
                                <div class="flex items-center justify-start gap-[10px]">
                                    <div
                        ...
                        <div class="">
                            <ul class="text-right md:text-center md:mt-2">
                                ...
                                <li class="inline-block ml-2"><a href="#"
                                        class="text-[#F78914] text-sm transition-all hover:text-[#687693]"><i
            ...
            <div class="wraper">
                <div
                    class="flex items-center justify-between bg-[#F7F6F1] rounded-[5px] -mb-6 relative z-10 px-[20px] header-box">
