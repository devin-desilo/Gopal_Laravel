...
@section('content')
            ...
            <div class="grid grid-cols-12">
                ...
                <div class="col-span-10 md:col-span-12">
                            ...
                            <div class="contact-item email-item">
                                ...
                                <p class="contact-text email-text">
                                    <a href="mailto:gopalagriexport@gmail.com"
                                        class="contact-link email-link">gopalagriexport@gmail.com</a>
                                </p>
                            </div>
                    ...
                    <div class="max-w-[440px] mx-auto text-center mb-[50px]">
                        <h2
                            class="text-[35px] col:text-[25px] text-[#0a272c] font-heading-font font-bold
                                mb-[20px]">
                            Have
                            Any Question?</h2>
                    ...
                    <div
                        class="p-[50px] bg-white mb-[-125px] relative z-10
                        ...
                        <form method="POST" action="{{ route('contact.send') }}" id="contact-form-main">
                            ...
                            <div
                                ...
                                <input type="text"
                                    class="form-control w-full bg-transparent border-[1px] border-[#ebebeb] h-[50px]
                    text-[#212529] transition-all pl-[25px] focus:outline-0 focus:shadow-none
                     focus:border-[#F5811E] focus:bg-transparent "
                                    name="name" id="name" placeholder="Your Name*">
                            </div>
                            <div
                                class="w-[calc(50%-30px)] float-left mx-[15px] mb-[25px] col:float-none col:w-[calc(100%-25px)]">
                                <input type="email"
                                    class="form-control  w-full bg-transparent border-[1px] border-[#ebebeb] h-[50px] text-[#212529] transition-all pl-[25px] focus:outline-0 focus:shadow-none  focus:border-[#F5811E] focus:bg-transparent"
                                    name="email" id="email" placeholder="Your Email*">
                            </div>
                            <div class="w-[calc-(100%-25px)] mb-[25px] mx-[15px]">
                                <textarea
                                    class="form-control  w-full bg-transparent border-[1px] border-[#ebebeb] h-[180px]  text-[#212529] transition-all pt-[15px] pl-[25px] focus:outline-0 focus:shadow-none  focus:border-[#F5811E] focus:bg-transparent"
                                    name="note" id="note" placeholder="Message..."></textarea>
                            </div>
                            <div class="text-center w-full mb-[10px]">
                                <button type="submit"
                                    class="bg-[#F5811E] text-[#fff] inline-block py-[12px] px-[22px] border
                    hover:text-[#F5811E]
                    border-transparent ] capitalize transition-all hover:bg-transparent
                    hover:border-[#F5811E]">Get
                                    in Touch</button>
                                <div id="loader">
                                    <i class="ti-reload"></i>
                                </div>
    ...
    <section class="wpo-contact-map-section">
        ...
        <div class="h-[550px]">
            <iframe class="w-full h-full border-0 outline-0 "
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3623.3433580732576!2d70.48349356386727!3d21.58657117209968!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39580304681e7f27%3A0xf7bc021acd6cd29a!2sShakti%20Enterprise!5e0!3m2!1sen!2sin!4v1722148666610!5m2!1sen!2sin"
