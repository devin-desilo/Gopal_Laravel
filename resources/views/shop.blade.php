...
@section('content')
    ...
    <div class="bg-[#f9f9f9] py-[120px] md:py-[90px] sm:py-[80px]">
        <div class="wraper">
            <div>
                <div class="gallery-container gallery-fancybox masonry-gallery gap-x-3 gap-y-5">
                    @foreach ($products as $product)
                        <div id="product-{{ $product['id'] }}"  class="product-box w-[400px] xl:w-[400px] lg:w-[280px] md:w-[44%] sm:w-full mx-[15px] sm:mx-0 milk fruit zoomIn"
                            ...
                            <div class="group bg-white p-0 transition mb-7 cursor-pointer relative text-center">
                                <div
                                    ...
                                    <div class="mx-auto">
                                        @if (count($product['images']) > 0)
                                            <img src="{{ asset('assets/images/product/' . $product['images'][0]) }}" alt=""
                                ...
                                <div class="transition product-text-div">
                                    <h2><a href="{{ route('products.show', $product['id']) }}"
                                            class="font-normal text-xl text-[#232323] font-heading-font mb-2 mt-1 transition hover:text-[#F78914]">{{ $product['name'] }}</a>
                                    </h2>
                                </div>
                                <div class="hidden">
                                    <div
