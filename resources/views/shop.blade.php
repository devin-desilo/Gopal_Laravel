    ...
    <div class="wraper">
        <div>
            <div class="grid products-wrap gap-x-3 gap-y-5">
                ...
                <div id="product-{{ $product->id }}" class="product-box  sm:w-full mx-[15px] sm:mx-0 milk fruit zoomIn" data-wow-duration="2000ms">
        ...
        <div class="pagination-container">
            <a href="{{ $products->previousPageUrl() }}" class="pagination-link {{ $products->onFirstPage() ? 'disabled' : '' }}">
                <!-- <span class="block md:hidden">
                    Previous
                </span> -->
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevrons-left">
            ...
            <a href="{{ $products->nextPageUrl() }}" class="pagination-link {{ !$products->hasMorePages() ? 'disabled' : '' }}">
                <!-- <span class="">
                    Next
                </span> -->
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevrons-right">
