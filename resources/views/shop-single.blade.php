                    ...
                    <div class="shop-single-slider">
                        <div class="slider-for">
                            @foreach ($product['images'] as $image)
                                <div class="cursor-pointer"><img src="{{ asset('assets/images/product/' . $image) }}" alt>
                                </div>
                            @endforeach
                        </div>
            ...
            <div class="mt-[75px]">
                ...
                <ul class="flex list-none flex-row flex-wrap border-b-0 pl-0" role="tablist" data-te-nav-ref>
                    <li role="presentation">
                        <a href="#tabs-home"
                            class=" block border-x-0 border-b-2 border-t-0 border-transparent px-7 pb-3.5 pt-4
                                ...
                                dark:data-[te-nav-active]:border-[#F5811E] dark:data-[te-nav-active]:text-[#F5811E]"
